/*************************************************************
 * 
 * jQuery formReady Plugin - Formulario de validación
 --------------------------------------------- 
...
(function($) {
    $.formReady = {
        ...
        showMessage: function(input, message) {
            ...
            $(input).parent().append('<span id=' + id + '><img src="images/formReadyErrorIcon.png" />' + message + '</span>').addClass('formReadyError');
        ...
        isName: function(input) {
            return  $.formReady.checkExpressionRegular(input, 'Debe ser un nombre valido !', /^[a-zA-Z áéíóúAÉÍÓÚÑñ]+$/);
        },
